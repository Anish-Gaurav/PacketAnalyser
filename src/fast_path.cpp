...
PacketAction FastPathProcessor::checkRules(const PacketJob& job, Connection* conn) {
    ...
    if (block_reason) {
        ...
        case RuleManager::BlockReason::Type::IP_ADDRESS:
            ss << "IP " << block_reason->detail;
            break;
        case RuleManager::BlockReason::Type::APPLICATION:
            ss << "App " << block_reason->detail;
            break;
        case RuleManager::BlockReason::Type::DOMAIN_NAME:
            ss << "Domain " << block_reason->detail;
            break;
        case RuleManager::BlockReason::Type::DESTINATION_PORT:
